  ...
  return (
    <div className="w-full max-w-2xl mx-auto flex flex-col gap-4 px-4 py-10">
      <div className="text-center mb-2">
        <p className="text-sm text-gray-500 dark:text-gray-400">技術トレンド キャッチアップ 学習実績</p>
        <h1 className="text-2xl font-bold brand-gradient-text mt-1">{user.publicNickname || "ユーザー"}さんの学習マップ</h1>
        <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">{memberSince}〜キャッチアップ中</p>
      </div>
      ...
      <div className="rounded-xl bg-white dark:bg-gray-900 shadow-sm border border-gray-200 dark:border-gray-800 p-4">
        <h2 className="font-bold text-gray-800 dark:text-gray-100 mb-3">分野別キャッチアップ状況</h2>
        {stats.readCount === 0 && stats.savedCount === 0 ? (
          <p className="text-xs text-gray-400 dark:text-gray-500">まだキャッチアップした記事がありません。</p>
        ) : (
