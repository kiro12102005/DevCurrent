        ...
        <div className="max-w-5xl mx-auto px-4 py-3.5 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-gray-500 dark:text-gray-400 leading-tight truncate">自動収集フィード＋URL深掘り要約</p>
            </div>
          </div>
        ...
        {TAB_ORDER.map((t) => {
          ...
          return (
            <button
              ...
              type="button"
              onClick={() => setTab(t)}
              className={`flex flex-col items-center gap-0.5 text-xs transition-colors ${tab === t ? "text-indigo-600 dark:text-indigo-400 font-semibold" : "text-gray-400 dark:text-gray-500"}`}
            >
